...
AIAgent agent = chatClient.CreateAIAgent(
    instructions: "You are a File System expert agent and GitHub repos expert. When working with files you need to provide the full path, not just the filename",
    tools: tools
    )
    .AsBuilder()
